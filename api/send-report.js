        ...
        body: JSON.stringify({
          ...
          htmlContent: `
            <div style="font-family:sans-serif;padding:24px;background:#0d0d1f;color:#fff">
              ...
              <a href="https://website-zeno-v2-j9e3.vercel.app/dashboard.html" style="display:inline-block;margin-top:16px;padding:12px 24px;background:#7b61ff;color:#fff;text-decoration:none;border-radius:8px">Voir mon dashboard</a>
            </div>
          `
        })
      })
