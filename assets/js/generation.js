...
function buildGenerationHTML(infs) {
  ...
  return '<div class="gen-wrap">' +
    ...
    '<div class="gen-options-grid">' +
    '<div class="gen-option" data-group="qualite" data-val="720p" onclick="selectOption(this,\'qualite\')"><span class="gen-option-label">720p</span></div>' +
    '<div class="gen-option selected" data-group="qualite" data-val="1080p" onclick="selectOption(this,\'qualite\')"><span class="gen-option-label">1080p</span></div>' +
    '<div class="gen-option" data-group="qualite" data-val="4K" onclick="selectOption(this,\'qualite\')"><span class="gen-option-label">4K</span></div>' +
    '</div>' +
...
function updatePreview() {
  ...
  if(!generationData.influenceur_id) return

  var ratios = { '9:16':'56.25% / 100%', '1:1':'100% / 100%', '16:9':'100% / 56.25%' }
  box.style.aspectRatio = generationData.format === '9:16' ? '9/16' :
                          generationData.format === '1:1'  ? '1/1'  : '16/9'
}
